...
[![Travis build
status](https://travis-ci.org/openvolley/ovideo.svg?branch=master)](https://travis-ci.org/openvolley/ovideo)
...
You can install from [GitHub](https://github.com/openvolley/ovideo)
with:
...
``` r
library(ovdata) ## install via remotes::install_github("openvolley/ovdata")
library(ovideo)
